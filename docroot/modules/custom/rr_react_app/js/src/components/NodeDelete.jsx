...
const NodeDelete = ({ id, title, onSuccess }) => {
  function doConfirm() {
    return window.confirm(`Are you sure you want to delete ${title}? This cannot be undone.`);
  }
  ...
  return (
    <button class="btn btn-outline-danger btn-sm" onClick={event => doConfirm() && doDelete()}>
      delete node
    </button>
  );
};
